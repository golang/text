...
//go:generate go run gen.go --versions=4.1.0,5.1.0,5.2.0,5.0.0,6.1.0,6.2.0,6.3.0,6.0.0,7.0.0,8.0.0,9.0.0,10.0.0,11.0.0,12.0.0,13.0.0,15.1.0,15.0.0
...
// size 6362 bytes (6 KiB)
var assigned15_1_0 = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x0000, 0x0377, 1},
		{0x037a, 0x037f, 1},
		{0x0384, 0x038a, 1},
